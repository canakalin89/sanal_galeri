...
fs.mkdirSync(output);
const files = ['index.html', 'style.css', 'script.js', 'gallery-data.js', 'artwork-tools.js', 'gallery-layout.js', 'gallery-room.js', 'gallery3d.js', 'admin.html', 'admin.css', 'admin-app.js', 'admin-state.js', 'exhibitions.json', 'THIRD_PARTY_ASSETS.md'];
